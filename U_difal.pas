...
then showmessage('Não haverá calculo do Difal entre os mesmos Estados! Verifique.');
IF (cb_uf_destino.text = 'AC') and (cb_uf_origem.text = 'AC')
  or (cb_uf_destino.text = 'PA') and (cb_uf_origem.text = 'PA')
  or (cb_uf_destino.text = 'ES') and (cb_uf_origem.text = 'ES')
  or (cb_uf_destino.text = 'GO') and (cb_uf_origem.text = 'GO')
 ...
 OR (cb_uf_destino.text = 'SC') and (cb_uf_origem.text = 'SC')
 OR (cb_uf_destino.text = 'SP') and (cb_uf_origem.text = 'SP')
then txt_base_icms_difal.text :='0';
IF (cb_uf_destino.text = 'AC') and (cb_uf_origem.text = 'AC')
  or (cb_uf_destino.text = 'PA') and (cb_uf_origem.text = 'PA')
  or (cb_uf_destino.text = 'ES') and (cb_uf_origem.text = 'ES')
  or (cb_uf_destino.text = 'GO') and (cb_uf_origem.text = 'GO')
 ...
 OR (cb_uf_destino.text = 'SC') and (cb_uf_origem.text = 'SC')
 OR (cb_uf_destino.text = 'SP') and (cb_uf_origem.text = 'SP')
then EDT_ALIQ_DIFAL_FINAL.text := '0';
IF (cb_uf_destino.text = 'AC') and (cb_uf_origem.text = 'AC')
  or (cb_uf_destino.text = 'PA') and (cb_uf_origem.text = 'PA')
  or (cb_uf_destino.text = 'ES') and (cb_uf_origem.text = 'ES')
  or (cb_uf_destino.text = 'GO') and (cb_uf_origem.text = 'GO')
 ...
 OR (cb_uf_destino.text = 'SC') and (cb_uf_origem.text = 'SC')
 OR (cb_uf_destino.text = 'SP') and (cb_uf_origem.text = 'SP')
then Edt_total_difal.text :='0';

end;


procedure Tfrm_difal.btn_editarClick(Sender: TObject);
//Configurando o botão de editar alíquota
begin
...
{Aplicando proteção para que não haja cálculo do DIFAL quando o combobox
...
then
  begin
    ...
    showmessage('Não haverá cálculo do Difal entre os mesmos Estados! Verifique.');
  end;

 {Aplicando Alíquota para o cálculo do DIFAL no edt_interestadual.text
...
then
  begin
  showmessage('Não haverá calculo do Difal entre os mesmos Estados! Verifique.');

  end
  {Aplicando alíquota de icms para cada estado conforme preenchimento
...
//Configurando o "difal duplo"
var
   icms_interno,icms_interestadual,base_calculo,base_dupla,
...
begin
  ...
  Edt_total_difal.text := Formatcurr('0,.00', resultado);
...
'Totalizando: '+currtostr(valor_icms_interestadual)+#13+
...
'Totalizando '+currToStr(base_calculo2)+#13+
'Feito isso, preicisamos agora achar o icms estadual'+#13+
'que será a base anterior de :'+currToStr(base_calculo2)+#13+
'multiplicado pela alíquota interna, de: '+FloatToStr(icms_interno)+#13+
'Totalizando um icms interno de: '+currToStr(valor_icms_estadual)+#13+
'Feito isso, o último passo será diminuir o icms estadual, de:'
+CurrToStr(valor_icms_estadual)+#13+
'Pelo icms interestadual, de '+CurrToStr(valor_icms_interestadual)+#13+
'Totalizando o difal em '+CurrToStr(resultado)+#13+
'Essa regra será valida apenas para os estados: '+#13+
'BA, MG, MS, PA, PI, PR, RS, SC, TO, SE, AL, GO, PE , PB e SP');
...
//calculando o valor de icms difal
  ...
  EDT_ALIQ_DIFAL_FINAL.text := FormatFloat('',(StrToFloat(edt_estadual.text) - StrToFloat(edt_interestadual.text)));
