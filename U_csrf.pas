...
procedure TFrm_csrf.Button2Click(Sender: TObject);
//configurando o botão de limpar
begin
var i:integer;
begin
 for i := 0 to    Frm_csrf.ComponentCount-1 do
...
//proteção para que o campo edt não receba valores nulos
begin
