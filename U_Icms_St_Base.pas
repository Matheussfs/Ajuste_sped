...
//proteção para não deixar o campo edt_vl_produto
begin
...
//proteção para não deixar o campo Edt_vl_seguro vazio
begin
...
begin
//configurando para que a base preencha automáticamente em outro form
//atalho altf11, deverá ser incluído o form, após, chama-lo
frm_icms_st.Edt_base_ST.text :=Edt_resultado_bc_st.text;
end;

procedure TFRM_BASE_ST.Edt_vl_descontoExit(Sender: TObject);
//proteção para não deixar o campo Edt_vl_desconto vazio
begin
...
//proteção para não deixar o campo aliq_mva vazio
begin
...
//proteção para não deixar o campo Edt_alq_frete vazio
begin
...
//proteção para não deixar o campo Edt_desp_acessorias vazio
begin
...
//proteção para não deixar o campo Edt_vl_ipi vazio
begin
